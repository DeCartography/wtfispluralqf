    ...
    <div class="h-screen relative w-full overflow-x-hidden">
      ...
      <div class="absolute inset-x-0 bottom-20 text-white w-full text-center">
        ...
        <p class="max-w-lg mb-6 mx-auto">
          <span class="font-bold">DeCartography</span> is a Relational Computation Oracle. Generate data process is fully decentralized, 
not fixed any indicator to analyze. clustering by the wisdom of crowds, based on wallet transaction
        </p>
        <p>
    ...
    >
      <div class="w-full md:w-1/2 md:pr-16">
        <p class="text-3xl mb-8">
          <span class="font-bold">Identity and policy modules for Plurality</span>
        </p>
        <p class="mb-10">
          DeCartography makes it possible to quantify the cooperation between contributors. 
          it gradually increase cooperation across differences and mute contributions between homogeneous and more highly cooperative groups
        </p>
        <p>
          <a
            class="underline"
    ...
    <div class="py-20 px-8 md:px-32" style="background-color: #f6f9fc">
      ...
      <p class="max-w-xl mx-auto">
          DeCartography data is generated by a human agent looking at addresses based on the NFTs and wallet transactions you have, 
          repeating them, and using the wisdom of the crowds and peer prediction methods.
      </p>
      
      <p class="max-w-xl mx-auto">
          This method is the only way to provide graph data without defining metrics for social graph generation, 
          unlike other social graph provisioning services.
      </p>

      <p class="max-w-xl mx-auto">
          If you are interested in becoming an Oracle validator and earning few bucks ETH in a matter of minutes, join the <u><a href="https://twitter.us21.list-manage.com/subscribe?u=096c22f9ecea47d0f6929b2c0&id=59034d3d6a">Waiting list</a>!</u>
      </p>

    </div>
      <!-- <img src="@/assets/images/worker-screen.jpg" /> -->
      <img src="https://i.gyazo.com/e64248b5a0cb293c047c65709a42f78a.jpg" alt="Image from Gyazo" />
    </div>
    ...
    <div class="px-8 md:px-32 py-20 md:py-40" style="background-color: #ebf1f9">
      <div class="flex flex-wrap mb-16">
        <div class="w-full md:w-1/2 md:pr-8 md:mb-0 mb-10">
          <p class="text-3xl mb-12">Public affairs should be decided by "everyone"</p>
          <p>
            "50 actually independent thinkers are worth more than 1000 NPCs who all consume the same media and vote the same way"
          </p>
          <p>
            Since the distribution of funds to public goods is a matter for everyone in the ecosystem, it is necessary to absorb as many diverse voices as possible.
          </p>
      ...
      <div class="flex flex-wrap">
        <div class="w-full md:w-1/2 md:pr-8 md:mb-0 mb-10 mt-10 md:mt-0">
          ...
          <p>
            The Plurality-oriented QF proposed by Vitalik was the first ParwiseQF model.
            Allows quadratic funding administrators to adjust the matching weights between any pair of contributors.
          </p>
          <p>
          Learn more about  <u><a href="https://ethresear.ch/t/pairwise-coordination-subsidies-a-new-quadratic-funding-design/5553">Pairwise coordination subsidies</a>!</u>
          </p>
        </div>
        <img
          class="w-full md:w-1/2 md:pl-8"
    ...
    <div class="py-24" style="background-color: #f6f9fc">
      ...
      <div class="flex flex-wrap px-8 md:px-28">
        <div class="w-full md:w-1/2 md:pr-8 md:mb-0 mb-10">
          ...
          <p>
            The image to the right is a graphical representation of the GR data. Each node in the network is a user (or grant) and each edge is a transaction between those nodes.
          </p>
        </div>
        <img
    ...
    <div class="py-10 mx-auto" style="background-color: ebf1f9">
          ...
          <div class="flex flex-wrap">
            <div class="w-full md:w-1/2 mb-10 md:mb-0 px-0 md:px-10">
              ...
              <p class="text-gray-500">
                Plural Quadratic Funding with DeCartography encourages support
                for projects that are supported by the broader community.
                it gradually increase cooperation across differences and mute contributions between homogeneous and more highly cooperative groups.
              </p>
            </div>
            <div
